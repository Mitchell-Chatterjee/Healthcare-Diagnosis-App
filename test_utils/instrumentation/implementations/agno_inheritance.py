...
from agno_test.agents.healthcare.test_utils.instrumentation.base.inheritance_base import InstrumentedBase
...
def create_test_case(instance: AgnoInstance, message: str, response: AgnoResponse) -> LLMTestCase:
    ...
    if hasattr(response, "tools") and response.tools:
        ...
        expected_tools = instance.workflow_session_state.get("expected_tools_by_agent", {}).get(instance.__class__.__name__, None)  # TODO: Make this expected into a shared enum

    return LLMTestCase(
        input=message,
        actual_output=actual_output,
        expected_output=instance.workflow_session_state.get("expected_output", None), # TODO: Also this one
